...
with st.form("chat_form", clear_on_submit=True):
    ...
    uploaded_file = st.file_uploader("Загрузить файл", label_visibility="collapsede", type=["pdf", "png", "jpg", "jpeg", "ogg", "mp3", "wav", "txt", "py", "md", "html", "csv"], key="file_uploader") # Добавьте нужные типы файлов
